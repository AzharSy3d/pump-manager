...
function Calculator() {
  ...
  return (
    <div>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Accordion>
              ...
              <AccordionDetails>
                <Box
                  sx={{
                    "& .MuiInputBase-root": { m: 1.2, width: "25ch" },
      ...
      <Box mt={4}>
        <AmountField title="Sale Amount" value={saleAmount} />
        <AmountField title="Amount Collected" value={finalTotal.toFixed(20)} />
        <AmountField
          title={balance > 0 ? "Profit" : "Balance"}
          value={balance.toFixed(20)}
        />
      </Box>
